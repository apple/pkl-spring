:uri-github-issue-pkl-spring: https://github.com/apple/pkl-spring/issues/new
:uri-seven-rules: https://cbea.ms/git-commit/#seven-rules 

= Pkl Spring Contributors Guide
...
Pkl Spring is released under the Apache 2.0 license.
...
To file a bug or feature request, use {uri-github-issue-pkl-spring}[GitHub].
